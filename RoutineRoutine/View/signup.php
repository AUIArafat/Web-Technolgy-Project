...
<html>
    ...
    <body>
        <div style="width:100%">
            ...
            <form  action="insertstudentinfo.php" method="POST" name="signup" style="width:36%;border:none">
                <div class="container">
                    <div class="clearfix">
                    ...
                    <div class="fake-input">
                        ...
                        <img src="tick.svg" onkeyup="verify(this)" id="img" style="display:none" width=25/>
                        <img src="error-icon-4.jpg" onkeyup="verify(this)" id="img1" style="display:none" width=25/>
                    </div>
                    ...
                    <div class="fake-input">
                        ...
                        <img src="tick.svg" onkeyup="verify(this)" id="eimg" style="display:none" width=25/>
                        <img src="error-icon-4.jpg" onkeyup="verify(this)" id="eimg1" style="display:none" width=25/>
                    </div>
                    
                    <div class="fake-input">
                        <input type="password" placeholder="Enter Password" name="pass" id="pass" onkeyup="verify(this)" required>
                        <img src="tick.svg" onkeyup="verify(this)" id="pimg" style="display:none" width=25/>
                        <img src="error-icon-4.jpg" onkeyup="verify(this)" id="pimg1" style="display:none" width=25/>
                    </div>
                    
                    <div class="fake-input">
                        <input type="password" placeholder="Repeat Password" name="cpass" id="cpass" onkeyup="verify(this)" required>
                        <img src="tick.svg" onkeyup="verify(this)" id="cimg" style="display:none" width=25/>
                        <img src="error-icon-4.jpg" onkeyup="verify(this)" id="cimg1" style="display:none" width=25/>
                    </div>
